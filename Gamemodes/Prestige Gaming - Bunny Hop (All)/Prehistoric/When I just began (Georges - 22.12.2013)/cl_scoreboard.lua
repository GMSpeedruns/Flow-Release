...
local PLAYER_LINE = 
{
	...
	Think = function( self )
		...
		if( self.RcTime == nil || self.RcTime != self.Player:GetNWInt("SBRC") ) then
			self.RcTime = self.Player:GetNWInt("SBRC",0)
			self.Rcs:SetText(string.sub(GAMEMODE.ModeName[self.Player:GetNWInt("BHType",1)],1,1).." - "..GetTime(self.RcTime))
		end
