...
function ENT:ViewModelChanged( vm, old, new )
	...
	-- Validation fix to avoid silly Lua errors when refreshing
	if ( not vm or not self or not vm.GetOwner or not self.GetOwner or not self.AttachToViewmodel ) then return end
