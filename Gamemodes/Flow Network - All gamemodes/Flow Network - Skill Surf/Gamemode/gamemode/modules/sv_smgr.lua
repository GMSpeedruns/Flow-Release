...
local S1, S2, S3 = _C.Style.Normal, _C.Style.Bonus, _C.Style.Practice
local function IsValidStyle( SX ) if SX == S1 or SX == S2 or SX == S3 then return true else return false end end
