...
Some essential files are in the /Essential files folder. Do not ignore these if you want a fully working server.
...
Also, please run this gamemode in 100 tick. Otherwise it will feel very weird.
